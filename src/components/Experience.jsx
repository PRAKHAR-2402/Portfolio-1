...
const Experience = () => {
  return (
    <div className="border-b border-neutral-900 pb-5">
        ...
        transition={{ duration: 1.5 }}className="w-full lg:w-1/4"><p>{experience.year}</p></motion.div>
                    <motion.div 
                      whileInView={{ opacity: 1, x: 0 }}
        initial={{ opacity: 0, x: 100 }}
        transition={{ duration: 1.5 }}className="w-full max-w-xl lg:w-3/4">
                    ...
                    <p className="mb-4 mt-2 text-neutral-400 text-justify">{experience.description}</p>
